					...
					<div className='bg-blue-2 fluid padded'>
						<Grid doubling stackable centered columns={5} className='footer-grid'>
							...
							<Grid.Column verticalAlign='middle' className='text-left'>
								...
								<a target='_blank' href='https://goo.gl/maps/Ukuj6Gi6D1dsn1oH7'>
                  <p className='white clickable'>
                    ...
                    USA
							...
							<Grid.Column verticalAlign='middle' textAlign='left'>
								<NavLink to='/privacy' onClick={() => this.props.goToPage('/privacy')}>
									<h6 className='white fs-2 clickable'>Privacy Policy</h6>
								</NavLink>
