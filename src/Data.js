...
export const company = {
  ...
  execs: {
    jay: {
      ...
      bio: [
        <p className="white">
          Since he founded the company in 1997, Mr. Hajeer has been instrumental
          in developing PSI into a modern high performance organization that
          embodies his vision: “We Deliver Practical Solutions!”
        </p>,
        <p className="white">
          Mr. Hajeer has built PSI into the trusted solution delivery partner of
          choice for our clients by drawing from his experience in leading
          technical programs and projects for several federal agencies as well
          as private sector entities.
        </p>,
        <p className="white">
          Mr. Hajeer’s vision for PSI is embodiedin his established approach
          known as Solution Delivery Methodology (SDM©). This structured
          methodology materialized gradually from the lessons learned in helping
          many organizations overcome Administrative, Engineering, and
    ...
    nik: {
      ...
      bio: [
        <p className="white">
          Nikolis G. Pirelli is the Director of Data and Analytics at PSI. He
          spent most of his professional career involved in the entire spectrum
          of data, from its creation and storage to its consumption and
          communication.
        </p>,
        <p className="white">
          He has held several leadership and technical roles throughout his
          career at various organizations and is well-known for his efficient
          and realistic methodologies along with his passion for data and its
          role in business strategy.
        </p>,
        <p className="white">
          Mr. Pirelli holds a B.S. in Finance from Arizona State University and
          a M.S. in Business Intelligence and Analytics from Saint Joseph’s
          University.
        </p>
      ]
    },
    bob: {
      ...
      bio: [
        <p className="white">
          Mr. Michels leads development and implementation of PSI’s strategy for
          the public sector and overall growth. His responsibilities include
          corporate direction, business development, and smart business
          partnerships.
        </p>,
        <p className="white">
          Mr. Michels has over 41 years experience in the federal sector prior
          to PSI. He has led the business growth of several firms helping them
          navigate the public sector marketplace. He was the Founder/CEO of
          Mobile Commerce & Computing, Inc. which was the first company to
          develop applications on hand-held devices.
        </p>,
        <p className="white">
          Mr. Michels has been featured a number of industry publications such
          as Forbes, Washington Technology, New York Reporter, and others.
        </p>
      ]
    },
    dave: {
      ...
      bio: [
        <p className="white">
          David Foresman is Vice President at PSI. David is an experienced
          management executive specializing in Information Security, Program
          Management and Solution delivery.
        </p>,
        <p className="white">
          David has been a key driver in business development and has led
          technical operations providing technical oversight and program
          management of several Federal and commercial contracts.
        </p>,
        <p className="white">
          Prior to PSI, David served on the board of Evolver Inc. and as the
          Director of the Knowledge management division. He also served as Vice
          President of the Enterprise services group for Business Strategies
          International.
        </p>
      ]
    }
