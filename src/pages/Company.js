        ...
        <div className="bg-white regular-width">
          ...
          <Grid verticalAlign="middle" stackable columns={3}>
            ...
            <Grid.Column width={6}>
                  ...
                  return (
                    <Grid.Row>
                      <Grid.Column style={{ objectFit: "contain", paddingRight: "0" }} width={5}>
                        <Image circular fluid src={require(`../assets/ourteam/${e.avitar}`)} />
                      </Grid.Column>
              ...
              <Modal closeIcon dimmer="blurring" basic open={this.state.open} onClose={() => this.toggleModal({ name: "Jay Hajeer", role: "I built the ground you walk on", image: "andrea.jpeg", bio: "something clearly went wrong" })}>
                <Modal.Header>{person.name} - {person.role}</Modal.Header>
                <Modal.Content scrolling>
                  <Modal.Description>
                    <Image size="medium" floated="left" src={require(`../assets/ourteam/${person.image}`)} />
                    { person.bio }
                  </Modal.Description>
                </Modal.Content>
              </Modal>
